...
import com.example.testarmlapplication.ml.classification.utils.Utils.average
import com.example.testarmlapplication.ml.classification.utils.Utils.subtractAll
import com.example.testarmlapplication.ml.classification.utils.Utils.multiplyAll
import com.example.testarmlapplication.ml.classification.utils.Utils.l2Norm2D
import com.example.testarmlapplication.ml.classification.utils.Utils.subtract
...
object PoseEmbedding {
    ...
    private fun normalize(landmarks: List<PointF3D>): List<PointF3D> {
        ...
        subtractAll(center, normalizedLandmarks.toMutableList())

        // Normalize scale.
        multiplyAll(normalizedLandmarks.toMutableList(), 1 / getPoseSize(normalizedLandmarks))
        // Multiplication by 100 is not required, but makes it easier to debug.
        multiplyAll(normalizedLandmarks.toMutableList(), 100f)
